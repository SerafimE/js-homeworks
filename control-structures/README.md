...
3. Напишите код со следующими условиями:
   ...
   1. Если в заказе указано число товаров, равное количеству товара на складе, то выводить сообщение `Вы забираете весь товар c нашего склада!`.
   1. В иных случаях выводить сообщение `Заказ оформлен`.
