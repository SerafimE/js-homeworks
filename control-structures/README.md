...
3. Напишите код со следующими условиями:
   1.ol Если в заказе указано число, превышающее количество товаров в наличии, то выводить сообщение `На складе нет такого количества товаров`.
   2.ol Если в заказе указано число товаров, равное количеству товара на складе, то выводить сообщение `Вы забираете весь товар c нашего склада!`.
   3.ol В иных случаях выводить сообщение `Заказ оформлен`.
